...
class CertificateControllerTest {
    ...
    private CertificateDto createTestDto(Long id) {
        var testDto = new CertificateDto();
        testDto.setId(id);
        testDto.setPhotoCertificate(new Byte[]{10, 20, 30});
    ...
    void readByIdPositiveTest() throws Exception {
        ...
        ResultActions response = mockMvc.perform(get("/certificate/{id}", id)
    ...
    void updatePositiveTest() throws Exception {
        ...
        ResultActions response = mockMvc.perform(put("/certificate/update/{id}", id)
                .contentType(MediaType.APPLICATION_JSON)
